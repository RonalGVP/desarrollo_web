...
function WeatherStats() {
  ...
  const filteredData = weatherData ? filterDataByDateRange(weatherData, dateRange) : [];
      ...
      <Navbar />
        <Card className="shadow-xl rounded-xl overflow-hidden backdrop-blur-sm bg-white/90">
          ...
          <CardContent className="p-6 space-y-8">
            {/* Date Range Selector - Ahora primero */}
            ...
            {/* Category Selector - Ahora segundo */}
            <div className="space-y-4">
              ...
              <CategorySelector 
                ...
                className="mt-4" // Añade espacio superior para mejor separación
              />
            </div>
          </CardContent>
        </Card>
